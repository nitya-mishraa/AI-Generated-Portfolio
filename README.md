...
## Project Purpose
The goal of this project was to create a **professional, interactive, and AI-enhanced portfolio** that:
- Represents my skills in AI, design, and development.
- Demonstrates the use of **AI-powered tools** for content generation and web design.
- Highlights seamless integration of AI in real-world applications.

---

##  Features
-  **AI-Generated Content** for About Me, Projects, and Portfolio sections.  
-  **AI Chatbot** for personalized user interactions.  
-  **Modern & Responsive Design** created using Wix AI suggestions.   
-  Organized sections for Skills, Projects, Contact, and Achievements.  

---

## Tools & Tech Stack
- **Wix AI** → Portfolio website design, layout suggestions, and content generation.  
- **Canva** → AI-generated visuals, banners, and icons.   
...
About Me: short paragraph about my background, education, and key AI/ML projects (Object Detection in Autonomous Cars, House Price Prediction, AgriSaarthi – AI Farming Assistant).

Skills: list programming languages, AI/ML tools, web design, and soft skills.

Projects: highlight my 3 main projects with short descriptions.
